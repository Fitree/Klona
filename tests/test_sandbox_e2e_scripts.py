...
class SandboxE2EScriptTests(unittest.TestCase):
    ...
    def test_inner_e2e_script_checks_expected_behaviors(self):
        ...
        self.assertIn('"Hello after compaction"', content)
        ...
        self.assertIn('check_mental_model_injection_at_user_message("Hello from scenario 1")', content)
        self.assertIn('check_mental_model_injection_at_user_message("Hello after compaction")', content)
